...
public class MovieCatalogue implements Parcelable {
    ...
    public final static Creator<MovieCatalogue> CREATOR = new Creator<MovieCatalogue>() {


        @SuppressWarnings({
                "unchecked"
        })
        public MovieCatalogue createFromParcel(Parcel in) {
            return new MovieCatalogue(in);
        }
