...
public class TvResponse implements Parcelable {
    ...
    @Expose
    private List<TvCatalogue> results = null;
    ...
    protected TvResponse(Parcel in) {
        ...
        results = in.createTypedArrayList(TvCatalogue.CREATOR);
    }
    ...
    public List<TvCatalogue> getResults() {
        return results;
    }

    public void setResults(List<TvCatalogue> results) {
